...
import NewMessageNotification
    from '@/Components/App/NewMessageNotification.jsx';
        ...
        conversations.forEach((conversation) => {
            ...
            if (conversation.is_user) {
                channel = `message.user.${[
                    parseInt(user.id),
                    parseInt(conversation.id), // user id from conversation resource
                ]
                    .sort((a, b) => a - b)
                    .join('-')}`;
            }
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col h-screen">
            <nav className="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 jufstify-between">
                        <div className="flex">
